...
scatter_df %>%
  ...
  scale_y_continuous(limits = c(low_range*0.95, high_range*1.05), 
                     breaks = c(mean(c(mid_pt, low_range*0.95)), mid_pt, mean(c(mid_pt, high_range*1.05))),
                     labels = c("Below Average \n Points For", 
                                paste(scales::number(mid_pt, big.mark = ","), "\nPoints"),
                                "Above Average \n Points For")) +
  scale_x_continuous(limits = c(low_range*0.95, high_range*1.05), 
                     breaks = c(mean(c(mid_pt, low_range*0.95)), mid_pt, mean(c(mid_pt, high_range*1.05))),
                     labels = c("Below Average \n Points Against", 
                                paste(scales::number(mid_pt, big.mark = ","), "\nPoints"),
                                "Above Average \n Points Against")) +
