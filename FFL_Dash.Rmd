...
scatter_df %>%
  ...
  scale_y_continuous(limits = c(low_range*.9, high_range*1.1), 
                     breaks = c(low_range + 40, mid_pt, high_range - 40),
                     labels = c("Below Average \n Points For", 
                                paste(scales::number(mid_pt, big.mark = ","), "\nPoints"),
                                "Above Average \n Points For")) +
  scale_x_continuous(limits = c(low_range*.9, high_range*1.1), 
                     breaks = c(low_range + 40, mid_pt, high_range - 40),
                     labels = c("Below Average \n Points Against", 
                                paste(scales::number(mid_pt, big.mark = ","), "\nPoints"),
                                "Above Average \n Points Against")) +
...
margins_long <- margins_df %>% 
  pivot_longer(cols = -Team, names_to = "Margin Type", values_to = "Margin")
...
margins_df %>%
  ...
  geom_text(
    ...
    aes(x = Team, y = Margin, label = Margin),
    size = 3,
    vjust = -1.25,
